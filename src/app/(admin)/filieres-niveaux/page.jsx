...
import EmploiDuTempsSection from '@/components/filieres-niveaux/EmploiDuTempsSection';
...
export default function FilieresNiveauxPage() {
  ...
  const onUpdateFiliere = (data) =>
    handleUpdate(
      updateFiliere, selectedItem.id, data, editModal,
  ...
  const onDeleteFiliere = () =>
    handleDelete(
      deleteFiliere, selectedItem.id, deleteModal,
  ...
  const onUpdateNiveau = (data) =>
    handleUpdate(
      updateNiveau, selectedItem.id, data, editModal,
  ...
  const onDeleteNiveau = () =>
    handleDelete(
      deleteNiveau, selectedItem.id, deleteModal,
      'Niveau supprimé avec succès',
      () => setSelectedItem(null)
    );

  // Props formulaires communs 
  ...
  return (
    <ListPageLayout
      title="Filières, Niveaux & Emploi du temps"
      description="Gérez les filières, les niveaux d'études et les emplois du temps."
      actionButton={
    ...
    >
      <ListPageFilters
        ...
        searchPlaceholder={
          activeTab === 'filieres'  ? 'Nom ou code filière...'      :
          activeTab === 'niveaux'   ? 'Nom du niveau ou filière...' :
                                     'Rechercher...'
        }
